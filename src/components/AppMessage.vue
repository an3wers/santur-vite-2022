<template>
    <div :class="[msgType[type]]" class="app-message rounded-xl py-6 px-4 space-x-4 inline-flex z-50 items-start shadow-lg">
        
        <div v-html="msgIcon[icon]"></div>
        <div class="grow text-white font-medium"><slot>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quae nam tempora vitae maxime impedit rerum! Repudiandae, adipisci sed praesentium optio animi voluptatum aut labore, odio laudantium architecto ea reiciendis.</slot></div>
        <close-icon-20 @click="close" color="#ffffff" aria-label="Close" role="button" class="opacity-70 mt-1 shrink-0 cursor-pointer" />
    </div>
</template>
...
const msgIcon = {
    ...
    'error': '<svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" height="24" width="24"><path d="M12 17q.425 0 .713-.288Q13 16.425 13 16t-.287-.713Q12.425 15 12 15t-.712.287Q11 15.575 11 16t.288.712Q11.575 17 12 17Zm-1-4h2V7h-2Zm1 9q-2.075 0-3.9-.788-1.825-.787-3.175-2.137-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175 1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138 1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"/></svg>',
    'warning': '<svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" height="24" width="24"><path d="M1 21 12 2l11 19Zm10-6h2v-5h-2Zm1 3q.425 0 .713-.288Q13 17.425 13 17t-.287-.712Q12.425 16 12 16t-.712.288Q11 16.575 11 17t.288.712Q11.575 18 12 18Z"/></svg>',
    'success': '<svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" height="24" width="24"><path d="m10.6 16.6 7.05-7.05-1.4-1.4-5.65 5.65-2.85-2.85-1.4 1.4ZM12 22q-2.075 0-3.9-.788-1.825-.787-3.175-2.137-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175 1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138 1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"/></svg>',
    'none': ''
}

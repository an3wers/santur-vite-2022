<template>
    ...
    >
        ...
        <div class="grow space-y-4">
            <slot>
                <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis deleniti nesciunt cumque non fuga laboriosam autem reiciendis quod nemo culpa, qui itaque repudiandae delectus neque obcaecati! Est pariatur cumque autem?</div>
            </slot>
        </div>
    </div>
</template>
